    ...
    <div className="contact_container">
      ...
      <div className="names">
        <div className="firstName">
          ...
          />
          {fnameHasError && (
            <p style={{ color: "red", fontSize: 12 }}>{fNameErrorMsg}</p>
          )}
        </div>
        <div className="lastName">
          ...
          />
          {lnameHasError && (
            <p style={{ color: "red", fontSize: 12 }}>{lnamehasErrorMsg}</p>
          )}
        </div>
      </div>
      <div className="email">
        ...
        />
        {EmailHasError && (
          <p style={{ color: "red", fontSize: 12 }}>{EmailhasErrorMsg}</p>
        )}
      </div>
      ...
      <div className="checkbox">
        <label className="checking" htmlFor="checkbox">
          By Clicking, You are agreeing to providing your data to Stephen Samuel
          who may contact you.
        </label>
        <input
          type="checkbox"
        ...
        />
        {checkBoxError && (
          <p style={{ color: "red", fontSize: 12 }}>do yo accept the terms & conditions ?.</p>
        )}
      </div>
      ...
      <h4>tips : tap the profile picture to navigate back </h4>
    </div>
  );
};
